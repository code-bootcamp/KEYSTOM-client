                        ...
                        <S.PaymentSubLeftWrapper>
                            ...
                            <S.PaymentSubTextWrapper>
                                ...
                                <S.InputBox
                                    ...
                                    defaultValue={
                                        props.userData?.fetchUserLoggedIn.user
                                            .name
                                    }
                                />
                            </S.PaymentSubTextWrapper>
                        ...
                        <S.PaymentSubRightWrapper>
                            ...
                            <S.PaymentSubDiv>
                                ...
                                >
                                    ...
                                    <S.LabelText>{`${
                                        props.couponDetailData?.fetchCoupon
                                            ?.discountPrice
                                            ? props.productData?.fetchProduct
                                                  ?.price +
                                              props.customData?.fetchCustom
                                                  ?.space *
                                                  8000 +
                                              props.customData?.fetchCustom
                                                  ?.esc *
                                              ...
                                              props.customData?.fetchCustom
                                                  ?.enter *
                                                  10000 -
                                              props.couponDetailData
                                                  ?.fetchCoupon?.discountPrice
                                            : props.productData?.fetchProduct
                                                  ?.price +
                                              props.customData?.fetchCustom
                                                  ?.space *

    ...
    useEffect(() => {
        if (
            ...
            if (
                ...
                length =
                    Object.values(state.items).filter((el) => el !== "#ffffff")
                        .length - 3;
...
function EscChangeKey() {
    ...
    useEffect(() => {
        ...
        setRecoilEscLength(
            Object.values(state.items)[47] !== "#ffffff" ? 1 : 0
        );
    });
...
function SpaceBarChangeKey() {
    ...
    useEffect(() => {
        ...
        setRecoilSpaceLength(
            Object.values(state.items)[33] !== "#ffffff" ? 1 : 0
        );
    });
...
function EnterChangeKey() {
    ...
    useEffect(() => {
        ...
        setRecoilEnterLength(
            Object.values(state.items)[14] !== "#ffffff" ? 1 : 0
        );
    });

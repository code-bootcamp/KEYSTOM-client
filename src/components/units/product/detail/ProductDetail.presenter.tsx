    ...
    useEffect(() => {
        if (
            ...
            if (
                ...
                length =
                    Object.values(keyboardState.items).filter(
                        (el) => el !== "#ffffff"
                    ).length - 3;
            } else if (
                Object.values(keyboardState.items)[14] !== "#ffffff" &&
...
function EnterChangeKey() {
    useEffect(() => {
        enterLength =
            Object.values(keyboardState.items)[14] !== "#ffffff" ? 1 : 0;
    });
...
function EscChangeKey() {
    useEffect(() => {
        escLength =
            Object.values(keyboardState.items)[47] !== "#ffffff" ? 1 : 0;
    });
    ...
    return (
        <>
            <group
                ...
                onClick={(e) => (
                    e.stopPropagation(),
                    (keyboardState.current = e.object.material.name)
                )}
                position={[-0.28, 0, -0.1]}
                rotation={[0, 0, 0]}
                scale={[2, 2, 2]}
    ...
    return (
        ...
        >
            <HexColorPicker
                ...
                onChange={(color) =>
                    (keyboardState.items[snap.current] = color)
                }
                style={{ width: "280px", height: "280px" }}
            />
            <div
                style={{
                    borderLeftColor: `${keyboardState.items[snap.current]}`,
                }}
            >

    ...
    <>
      ...
      >
        <mesh
          ...
          material-color={props.currentColor}
        />
        <mesh
          castShadow
          receiveShadow
...
export default function ProductDetailPresenter() {
  ...
  const onClickColor1 = () => {
    setCurrentColor("#ff3e3e");
    console.log(currentColor);
  };

  const onClickColor2 = () => {
    setCurrentColor("#FFA030");
  };

  const onClickColor3 = () => {
    setCurrentColor("#FFE351");
  };

  const onClickColor4 = () => {
    setCurrentColor("#A3FF5B");
  };

  const onClickColor5 = () => {
    setCurrentColor("#83E1FF");
  };

  const onClickColor6 = () => {
    setCurrentColor("#627BFF");
  };

  const onClickColor7 = () => {
    setCurrentColor("#9D50FF");
  };

  const onClickColor8 = () => {
    setCurrentColor("#52068D");
  };

  const onClickColor9 = () => {
    setCurrentColor("#FF83E4");
  };

  const onClickColor10 = () => {
    setCurrentColor("#FF1392");
  };

  const onClickColor11 = () => {
    setCurrentColor("#474747");
  };

  const onClickColor12 = () => {
    setCurrentColor("#000000");
  };

  const onClickColor13 = () => {
    setCurrentColor("#FFDCDC");
  };

  const onClickColor14 = () => {
    setCurrentColor("#FFFFFF");
  };

  const onClickColor15 = () => {
    setCurrentColor("#06E9A5");
  };

  const onClickColor16 = () => {
    setCurrentColor("#E8D1FF");
  };
          ...
          <S.ImageRight>
            ...
            >
              <Suspense fallback={null}>
                <Keyboard currentColor={currentColor} />
